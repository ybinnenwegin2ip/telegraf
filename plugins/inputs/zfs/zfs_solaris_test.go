...
// kstat -p -n vdev_cache_stats
var kstat_vdev_cache_stats_output = []string{
	"zfs:0:vdev_cache_stats:class    misc",
	"zfs:0:vdev_cache_stats:crtime   587128.785621253",
	"zfs:0:vdev_cache_stats:delegations      0",
	"zfs:0:vdev_cache_stats:hits     0",
	"zfs:0:vdev_cache_stats:misses   0",
	"zfs:0:vdev_cache_stats:snaptime 674615.090102036",
}

// kstat -p -n zfetchstats
var kstat_zfetchstats_output = []string{
	"zfs:0:zfetchstats:class misc",
	"zfs:0:zfetchstats:crtime        587128.370435776",
	"zfs:0:zfetchstats:hits  10568",
	"zfs:0:zfetchstats:max_streams   14722989",
	"zfs:0:zfetchstats:misses        14820414",
	"zfs:0:zfetchstats:snaptime      674558.452215236",
